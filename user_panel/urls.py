...
urlpatterns = [
    ...
    path('communication/group-chat/<int:group_id>/edit-message/', views.edit_group_message, name='edit_group_message'),
    path('communication/group-chat/<int:group_id>/delete-message/', views.delete_group_message, name='delete_group_message'),
